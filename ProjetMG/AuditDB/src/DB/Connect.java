...
public class Connect {
	...
	public static String getPort(String filename) {
		...
		try {
			...
			//get the property value
			port = (prop.getProperty("portpath"));
	...
	public static String getSchem(String filename) {
		...
		try {
			...
			//get the property value
			schem = (prop.getProperty("schempath"));
